          ...
          {states.map((state, index) => (
            ...
            >
              ...
              <input
                ...
                className="flex-1 min-w-0 border border-transparent hover:border-[var(--border-default)] focus:border-[var(--border-focus)] rounded-[var(--radius-input)] px-2 py-1 text-[13px] bg-transparent focus:bg-[var(--bg-surface)] text-[var(--text-primary)] focus:outline-none transition-colors"
              />
          ...
          <div className="flex items-end gap-2 p-3 border border-dashed border-[var(--border-strong)] rounded-[var(--radius-card)] bg-[var(--bg-surface-hover)]">
            <div className="flex flex-col gap-1.5 flex-1">
              ...
              <input
                ...
                className="border border-[var(--border-default)] rounded-[var(--radius-input)] px-3 py-1.5 text-[13px] bg-[var(--bg-surface)] text-[var(--text-primary)] focus:outline-none focus:border-[var(--border-focus)]"
              />
            </div>
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[var(--brand-primary)] text-white text-[12px] font-medium rounded-[var(--radius-button)] hover:opacity-90 disabled:opacity-50 transition-colors flex items-center gap-1 shrink-0"
            >
